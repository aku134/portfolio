    ...
    <section id="contact" className="section">
      ...
      <div className="contact-wrapper">
        ...
        <div className="contact-links">
          ...
          <a href="https://www.linkedin.com/in/akshita-verma-5a491818b/" target="_blank" rel="noreferrer" className="contact-item card">
            <span className="contact-icon">
            ...
            <div>
              ...
              <div className="contact-value">linkedin.com/in/akshita-verma</div>
            </div>
          </a>

          <a href="https://github.com/aku134" target="_blank" rel="noreferrer" className="contact-item card">
            <span className="contact-icon">
              <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <div className="contact-value">github.com/aku134</div>
            </div>
          </a>
