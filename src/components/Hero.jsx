        ...
        <div className="hero-top">
          <div className="hero-text">
            ...
            <div className="hero-links">
              ...
              <a href="https://www.linkedin.com/in/akshita-verma-5a491818b/" target="_blank" rel="noreferrer" className="hero-link">
              ...
              <a href="https://github.com/aku134" target="_blank" rel="noreferrer" className="hero-link">
                <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
